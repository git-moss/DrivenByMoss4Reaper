...
public class TrackBankImpl extends AbstractTrackBankImpl
{
     ...
     *            tracks if flat
     */
    public TrackBankImpl (final List<IDrumDevice> drumDevices, final DataSetupEx dataSetup, final int numTracks, final int numScenes, final int numSends, final boolean hasFlatTrackList, final boolean hasFullFlatTrackList)
    {
