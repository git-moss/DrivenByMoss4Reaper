...
public class Push1ControllerInstance extends AbstractControllerInstance
{
     ...
     */
    public Push1ControllerInstance (final LogModel logModel, final Window window, final MessageSender sender)
    {
        super (new PushControllerDefinition (false), logModel, window, sender);
    }
    ...
    {
        return new PushControllerSetup (this.host, setupFactory, this.settingsUI, false);
    }
}
