...
public class MCU2ControllerInstance extends AbstractControllerInstance
{
     ...
     */
    public MCU2ControllerInstance (final LogModel logModel, final Window window, final MessageSender sender)
    {
        super (new MCUControllerDefinition (1), logModel, window, sender);
    }
