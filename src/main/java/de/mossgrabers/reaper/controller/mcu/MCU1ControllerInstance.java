...
public class MCU1ControllerInstance extends AbstractControllerInstance
{
     ...
     */
    public MCU1ControllerInstance (final LogModel logModel, final Window window, final MessageSender sender, final IniFiles iniFiles)
    {
        super (new MCUControllerDefinition (0), logModel, window, sender, iniFiles);
    }
