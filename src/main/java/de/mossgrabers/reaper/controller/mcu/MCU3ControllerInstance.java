...
public class MCU3ControllerInstance extends AbstractControllerInstance
{
     ...
     */
    public MCU3ControllerInstance (final LogModel logModel, final Window window, final MessageSender sender)
    {
        super (new MCUControllerDefinition (2), logModel, window, sender);
    }
    ...
    {
        return new MCUControllerSetup (this.host, setupFactory, this.settingsUI, 3);
    }
}
