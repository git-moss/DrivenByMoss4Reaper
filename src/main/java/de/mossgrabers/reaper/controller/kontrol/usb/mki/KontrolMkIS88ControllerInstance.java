...
public class KontrolMkIS88ControllerInstance extends AbstractControllerInstance
{
     ...
     */
    public KontrolMkIS88ControllerInstance (final LogModel logModel, final Window window, final MessageSender sender)
    {
        super (new Kontrol1ControllerDefinition (3), logModel, window, sender);
    }
