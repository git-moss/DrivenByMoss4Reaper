...
package de.mossgrabers.reaper.controller.kontrol.osc.mkii;
...
public class KontrolMkIIControllerInstance extends AbstractControllerInstance
{
     ...
     */
    public KontrolMkIIControllerInstance (final LogModel logModel, final Window window, final MessageSender sender)
    {
        super (new KontrolOSCControllerDefinition (), logModel, window, sender);
    }
    ...
    {
        return new KontrolOSCControllerSetup (this.host, setupFactory, this.settingsUI);
    }
}
