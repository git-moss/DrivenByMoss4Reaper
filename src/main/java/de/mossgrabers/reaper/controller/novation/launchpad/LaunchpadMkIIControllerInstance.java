 ...
 */
public class LaunchpadMkIIControllerInstance extends AbstractControllerInstance<LaunchpadControlSurface, LaunchpadConfiguration>
{
     ...
     */
    public LaunchpadMkIIControllerInstance (final LogModel logModel, final WindowManager windowManager, final BackendExchange sender, final IniFiles iniFiles)
    {
