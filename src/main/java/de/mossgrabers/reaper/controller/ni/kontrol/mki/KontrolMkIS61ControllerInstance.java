 ...
 */
public class KontrolMkIS61ControllerInstance extends AbstractControllerInstance<Kontrol1ControlSurface, Kontrol1Configuration>
{
     ...
     */
    public KontrolMkIS61ControllerInstance (final LogModel logModel, final WindowManager windowManager, final BackendExchange sender, final IniFiles iniFiles)
    {
