...
public class LaunchpadProControllerInstance extends AbstractControllerInstance
{
     ...
     */
    public LaunchpadProControllerInstance (final LogModel logModel, final Window window, final MessageSender sender)
    {
        super (new LaunchpadControllerDefinition (false), logModel, window, sender);
    }
    ...
    {
        return new LaunchpadControllerSetup (this.host, setupFactory, this.settingsUI, true);
    }
}
