...
public class APC40mkIControllerInstance extends AbstractControllerInstance
{
     ...
     */
    public APC40mkIControllerInstance (final LogModel logModel, final Window window, final MessageSender sender, final IniFiles iniFiles)
    {
        super (new APCControllerDefinition (false), logModel, window, sender, iniFiles);
    }
