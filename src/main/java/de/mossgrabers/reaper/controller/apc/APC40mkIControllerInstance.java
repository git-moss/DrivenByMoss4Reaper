 ...
 */
public class APC40mkIControllerInstance extends AbstractControllerInstance
{
    /**
     * Constructor.
     *
     ...
     */
    public APC40mkIControllerInstance (final LogModel logModel, final Window window, final MessageSender sender)
    {
        super (new APCControllerDefinition (false), logModel, window, sender);
    }
    ...
    {
        return new APCControllerSetup (this.host, setupFactory, this.settingsUI, false);
    }
}
