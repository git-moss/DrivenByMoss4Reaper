 ...
 */
public class APCminiMk2ControllerInstance extends AbstractControllerInstance<APCminiControlSurface, APCminiConfiguration>
{
    /** The controller definition instance. */
    public static final APCminiMk2ControllerDefinition CONTROLLER_DEFINITION = new APCminiMk2ControllerDefinition ();
     ...
     */
    public APCminiMk2ControllerInstance (final LogModel logModel, final WindowManager windowManager, final BackendExchange sender, final IniFiles iniFiles)
    {
