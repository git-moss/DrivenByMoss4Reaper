...
/**
 * Mode for editing project parameters.
 *
 * @author Jürgen Moßgraber
 */
public class MCUProjectParametersMode extends BaseMode<IParameter>
{
    /**
     * Constructor.
     *
     ...
     */
    public MCUProjectParametersMode (final MCUControlSurface surface, final IModel model)
    {
